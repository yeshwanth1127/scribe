...
var URLTriggerMatching = /** @class */ (function () {
    ...
    URLTriggerMatching.prototype.onConfig = function (config) {
        var _a, _b;
        this._urlTriggers =
            (isEagerLoadedConfig(config) ? (_a = config.sessionRecording) === null || _a === void 0 ? void 0 : _a.urlTriggers : config === null || config === void 0 ? void 0 : config.urlTriggers) || [];
        this._urlBlocklist =
            (isEagerLoadedConfig(config) ? (_b = config.sessionRecording) === null || _b === void 0 ? void 0 : _b.urlBlocklist : config === null || config === void 0 ? void 0 : config.urlBlocklist) || [];
    };
    /**
...
var LinkedFlagMatching = /** @class */ (function () {
    ...
    LinkedFlagMatching.prototype.onConfig = function (config, onStarted) {
        ...
        var _a;
        this.linkedFlag =
            (isEagerLoadedConfig(config) ? (_a = config.sessionRecording) === null || _a === void 0 ? void 0 : _a.linkedFlag : config === null || config === void 0 ? void 0 : config.linkedFlag) || null;
...
var EventTriggerMatching = /** @class */ (function () {
    ...
    EventTriggerMatching.prototype.onConfig = function (config) {
        var _a;
        this._eventTriggers =
            (isEagerLoadedConfig(config) ? (_a = config.sessionRecording) === null || _a === void 0 ? void 0 : _a.eventTriggers : config === null || config === void 0 ? void 0 : config.eventTriggers) || [];
    };
    /**
     * @deprecated Use onConfig instead
     */
