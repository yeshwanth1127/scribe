...
class PostHogTauri {
    ...
    static async _performInit() {
        try {
            ...
            const config = await core.invoke('plugin:posthog|get_config');
            ...
            const existingDistinctId = await core.invoke('plugin:posthog|get_distinct_id');
    ...
    static async identify(distinctId, properties) {
        ...
        await core.invoke('plugin:posthog|identify', {
    ...
    static async reset() {
        ...
        await core.invoke('plugin:posthog|reset');
    ...
    static async getDistinctId() {
        await this.init();
        const backendDistinctId = await core.invoke('plugin:posthog|get_distinct_id');
...
exports.PostHog = PostHogTauri;
exports.PostHogTauri = PostHogTauri;
exports.default = PostHogTauri;
